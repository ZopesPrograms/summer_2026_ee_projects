...
#define DISP_INV_ON      0x21 // turns on display inversion (we want a photographic negative display!)
...
#define READ_DISP_ID     0x04 // reads the lcd display's identification information
